  ...
  data: [
      ...
      skills: [
        ...
        },
        {
          ...
          descriptions: [
            ...
            'Hooks は素晴らしー。',
            'redux, MobX とか flux architecture 領域のライブラリには正直あんまり関心がないです。設計がきっちりしてれば OK（それがムズいんだけど）。ちなみにお仕事では MobX を使ってます。',
        ...
        },
        {
          subject: 'HTML',
          descriptions: [
            'デザインや要求に応じたタグを使うようにしています。間違えることももちろんありますが。',
            'WAI-ARIA もできる範囲で気を使ってます。型をつけるイメージです。',
          ],
        },
        {
          subject: 'SVG',
          descriptions: [
            'ふつうに便利だなと思いながらごりごりいじっています。Web で Typography やるなら一択だと思っています。',
            'IE の都合で CSS でできない表現を SVG 使ってやる、みたいなことは日常でした。',
            'へんなことをやりたくていろいろ調査して発表したこともあります。',
            '変形系はあんまり得意ではない（CSS に逃げてしまう）ので、今後学んでいきたいと思っています。',
          ],
        },
        {
          subject: 'Web 制作',
        ...
        },
        {
          ...
          descriptions: [
            ...
            'Universal JavaScript の開発環境もスクラッチで組んだことはあります（ただしプロダクションでは無しです）。',
            'ただし最近では Next.js や Nuxt.js の上で開発するのが大抵の場合において最適解になりえると考えています。',
            'Rollup を用いた React のコンポーネントライブラリ開発環境もできます。',
          ],
        },
      ],
    },
    {
      ...
      skills: [
        ...
        {
          subject: '認証系',
          descriptions: ['基本的なことはもちろんわかっておりますが、雰囲気でやってます。'],
        },
        {
          subject: 'デザイン',
